...
# create variables
messagePrefix="install_alacritty >>"
...
# stow alacritty from the parent directory of this script
echo "${messagePrefix} Stowing alacritty"
(cd "$(dirname -- "$scriptPath")/../../stowables/mac" && stow -t ~ alacritty/)
